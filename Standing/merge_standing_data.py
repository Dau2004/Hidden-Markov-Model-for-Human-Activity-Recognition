...
# Path to your Standing folder
standing_path = "/Users/ram/Development/HMM Data/Standing"

# Prepare a list to hold all dataframes
dataframes = []

# Loop through each subfolder (Standing_1, Standing_2, etc.)
for folder in os.listdir(standing_path):
    subfolder_path = os.path.join(standing_path, folder)
...
# Save to file
output_path = os.path.join(standing_path, "Standing_all.csv")
final_df.to_csv(output_path, index=False)

print(f"✅ Merged all Standing CSVs into: {output_path}")
