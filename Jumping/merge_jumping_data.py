...
# Path to your Jumping folder
jumping_path = "/Users/ram/Development/HMM Data/Jumping"

# Prepare a list to hold all dataframes
dataframes = []

# Loop through each subfolder (Jumping_1, Jumping_2, etc.)
for folder in os.listdir(jumping_path):
    subfolder_path = os.path.join(jumping_path, folder)
...
# Save to file
output_path = os.path.join(jumping_path, "Jumping_all.csv")
final_df.to_csv(output_path, index=False)

print(f"✅ Merged all Jumping CSVs into: {output_path}")
