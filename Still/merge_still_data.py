...
still_path = "/Users/ram/Development/HMM Data/Still"

# Prepare a list to hold all dataframes
dataframes = []

# Loop through each subfolder (Still_1, Still_2, etc.)
for folder in os.listdir(still_path):
    subfolder_path = os.path.join(still_path, folder)
...
# Save to file
output_path = os.path.join(still_path, "Still_all.csv")
final_df.to_csv(output_path, index=False)

print(f"✅ Merged all Still CSVs into: {output_path}")
